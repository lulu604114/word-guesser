...
import CebOralSession from './CebOralSession';
  ...
  if (selectedText) {
    return (
      <Flex direction="column" align="center" w="100%" p={{ base: 4, md: 8 }} maxW="900px" mx="auto">
        <CebOralSession text={selectedText} onExit={() => setSelectedText(null)} />
      </Flex>
    );
  }
      ...
      <Box w="100%" maxW="800px" mt={8}>
        ...
        <Box layerStyle="glass">
          ...
          <Text fontSize="sm" color="gray.400" textAlign="center" mb={8}>
            Le texte sera lu à voix haute. Écoute bien, puis réponds aux questions !
          </Text>
              ...
              {enrichedTexts.map(text => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text color="gray.400" fontSize="sm" mb={3} fontStyle="italic">
                      Le texte sera lu à voix haute
                    </Text>
                    {qCount > 0 ? (
